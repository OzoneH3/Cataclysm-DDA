...
void player::hardcoded_effects( effect &it )
{
    ...
    if( id == effect_dermatik ) {
        ...
        bool compatible_weather_types = g->weather.weather == WEATHER_CLEAR || g->weather.weather == WEATHER_SUNNY
                                        || g->weather.weather == WEATHER_DRIZZLE || g->weather.weather == WEATHER_RAINY
                                        || g->weather.weather == WEATHER_FLURRIES || g->weather.weather == WEATHER_CLOUDY
                                        || g->weather.weather == WEATHER_ACID_CLOUDS || g->weather.weather == WEATHER_SNOW;
